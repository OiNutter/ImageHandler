...
class ImageHandler {
	...
	private $output_type;
	private $new_img;
	private $keep_aspect = true;
	private $should_crop = false;			private $font_path = "C:/Windows/Fonts/";
